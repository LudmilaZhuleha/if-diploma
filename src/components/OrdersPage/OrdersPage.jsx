    ...
    <div>
      <div className={styles.container}>
        <Header
          ...
          menu={
            <Menu
              books={<MenuItem type="item-account" onClick={goToAllBooks}>All Books</MenuItem>}
        ...
        <MainContent style="content">
          <Section type="section-orders">
            ...
            {waitings.length > 0 ? (<WaitingList waitings={waitings} />) : (<p className={styles.orders_text}>Oops! You are not waiting for any book </p>)}
          </Section>
          <Section type="section-orders">
            <h2 className={styles.orders_title}>List of your Books</h2>
            {orders.length > 0 ? (<OrdersList orders={orders} />) : (<p className={styles.orders_text}>Oops! You are not having any books </p>)}
          </Section>
        </MainContent>
      </div>
